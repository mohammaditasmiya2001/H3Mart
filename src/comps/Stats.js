...
function Stats() {
    return (
        <section style={{paddingBottom:"8%",height:"200px"}} className="w-full m-0 pl-0 pr-0 ml-0 absolute bg-gradient-to-r from-indigo-800 to-blue-400 text-white body-font ">
